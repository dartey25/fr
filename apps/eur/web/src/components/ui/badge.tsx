...
const badgeVariants = cva(
  "tw-inline-flex tw-items-center tw-rounded-[15px] tw-border tw-px-2 tw-py-0  tw-text-[10px] tw-text-center tw-font-semibold tw-transition-colors focus:tw-outline-none",
  {
    variants: {
      variant: {
        default:
